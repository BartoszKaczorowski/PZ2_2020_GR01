...
//$connect=mysqli_connect('heltica.cba.pl','helticadb','Helticadb1','heltica');
$connect = mysqli_connect("localhost", "root", "", "heltica");
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="cusisineChinese.php"</script>';
			}
		}
	}
}
...
<section style=" width: 50%;">
		...
		<br />
		<div class="container">
			<h1 align="center">MENU - Kuchnia chińska</h1><br />
			<br /><br />
            <?php
            // wyciągam dania z bazy danych
				$query = "SELECT * FROM m_dania WHERE id_lokalu = 3";

				$_SESSION['WybranyLokal']=3;
			...
			<div style="margin-bottom: 50px;" class="col-md-6">
                <form method="post" action="cusisineChinese.php?action=add&id=<?php echo $row["id_dania"]; ?>">
			...
			<div class="table-responsive" >
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a style="text-decoration: none;" href="cusisineChinese.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Usuń</span></a></td>
					</tr>
					<?php
...
<a class="submit" href="submitOrder.php">Przejdź do finalizacji zamówienia</a>
